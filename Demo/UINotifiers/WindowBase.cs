...
namespace Demo
{
    public class WindowBase : NavigationWindow, INotifyPropertyChanged
    {
        public WindowBase()
        {
        ...
        void OnViewLoaded(object sender, System.Windows.RoutedEventArgs e) { OnViewLoaded((Window)sender); ShowsNavigationUI = false; }
